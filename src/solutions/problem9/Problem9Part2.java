...
/**
 * Solution to problem nine, part two of Advent of Code.
 * https://adventofcode.com/2023/day/9
 *
 * Answer is 973
 */
public class Problem9Part2 {
    private final ArrayList<int[]> lines = new ArrayList<>();

    /** Constructor */
    public Problem9Part2() {
        try {
    ...
    private int processLine(int[] line) {
        ...
        // Find the next value
        System.out.println("Calculating historical number for " + Arrays.toString(line));
        int value = 0;
        for (int i=history.size()-1; i >= 0; i--) {
            int v2 = history.get(i)[0];
