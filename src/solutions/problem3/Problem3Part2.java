...
public class Problem3Part2 {
    ...
    private void checkArea(int x, int y) {
        ...
        // To be considered a gear, they need to have at least two numbers
        if (partNumbers.size() > 1) {
            ...
            System.out.print("\ngear value: " + value);
            ALL_NUMBERS.add(String.valueOf(value));
        }
    }
